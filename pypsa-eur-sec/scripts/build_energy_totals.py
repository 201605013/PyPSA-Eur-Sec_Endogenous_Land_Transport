...
def idees_per_country(ct, year):
    ...
    df = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[year] # Here number of cars are added
    ...
    ct_totals["vehicle-km driven"] = df[31]*10**6 # As it is in mio. km in the datasheet.

    # Add number of ICEV and EV from 2001-2015 (new vehicle-registrations):
    df2001 = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[2001]
    df2002 = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[2002]
    df2003 = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[2003]
    df2004 = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[2004]
    df2005 = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[2005]
    df2006 = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[2006]
    df2007 = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[2007]
    df2008 = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[2008]
    df2009 = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[2009]
    df2010 = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[2010]
    df2011 = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[2011]
    df2012 = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[2012]
    df2013 = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[2013]
    df2014 = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[2014]
    df2015 = pd.read_excel(fn_transport, "TrRoad_act", index_col=0)[2015]
    
    ct_totals["ICEV 2001-2005"] = (df2001[112]+df2002[112]+df2003[112]+df2004[112]+df2005[112]
                                   -df2001[118]-df2002[118]-df2003[118]-df2004[118]-df2005[118])
    ct_totals["ICEV 2006-2010"] = (df2006[112]+df2007[112]+df2008[112]+df2009[112]+df2010[112]
                                   -df2006[118]-df2007[118]-df2008[118]-df2009[118]-df2010[118])
    ct_totals["ICEV 2011-2015"] = (df2011[112]+df2012[112]+df2013[112]+df2014[112]+df2015[112]
                                   -df2011[118]-df2012[118]-df2013[118]-df2014[118]-df2015[118])
    ct_totals["EV 2001-2005"] = df2001[118]+df2002[118]+df2003[118]+df2004[118]+df2005[118]
    ct_totals["EV 2006-2010"] = df2006[118]+df2007[118]+df2008[118]+df2009[118]+df2010[118]
    ct_totals["EV 2011-2015"] = df2011[118]+df2012[118]+df2013[118]+df2014[118]+df2015[118]
...
def build_idees(countries, year):
    ...
    exclude = exclude+totals.index.str.fullmatch("vehicle-km driven") # Added to not change the values
    exclude = exclude+totals.index.str.fullmatch("ICEV 2001-2005")
    exclude = exclude+totals.index.str.fullmatch("ICEV 2006-2010")
    exclude = exclude+totals.index.str.fullmatch("ICEV 2011-2015")
    exclude = exclude+totals.index.str.fullmatch("EV 2001-2005")
    exclude = exclude+totals.index.str.fullmatch("EV 2006-2010")
    exclude = exclude+totals.index.str.fullmatch("EV 2011-2015")
...
def build_energy_totals(countries, eurostat, swiss, idees):
    ...
    to_drop = ["passenger cars","vehicle-km driven", "passenger car efficiency"]
...
# EDIT IN SCRIPT BELOW '''' ENDOGENOUS ELECTRIFICATION OF TRANSPORT '''' To fill up missing data.
    transport_data["vehicle-km driven"] = idees["vehicle-km driven"]
    missing = transport_data.index[transport_data["vehicle-km driven"].isna()]
    km_pc = transport_data["vehicle-km driven"] / transport_data["number cars"]
    transport_data.loc[missing, "vehicle-km driven"] = km_pc.mean() * transport_data["number cars"]
    # Fill missing values with the mean taking into account the number of cars estimated earlier.
    transport_data["km per vehicle"] = transport_data["vehicle-km driven"] / transport_data["number cars"] # average km per vehicle
        
    transport_data["ICEV 2001-2005"] = idees["ICEV 2001-2005"]
    cars_pp = transport_data["ICEV 2001-2005"] / population
    transport_data.loc[missing, "ICEV 2001-2005"] = cars_pp.mean() * population
    
    transport_data["ICEV 2006-2010"] = idees["ICEV 2006-2010"]
    cars_pp = transport_data["ICEV 2006-2010"] / population
    transport_data.loc[missing, "ICEV 2006-2010"] = cars_pp.mean() * population
    
    transport_data["ICEV 2011-2015"] = idees["ICEV 2011-2015"]
    cars_pp = transport_data["ICEV 2011-2015"] / population
    transport_data.loc[missing, "ICEV 2011-2015"] = cars_pp.mean() * population
    
    transport_data["EV 2001-2005"] = idees["EV 2001-2005"]
    cars_pp = transport_data["EV 2001-2005"] / population
    transport_data.loc[missing, "EV 2001-2005"] = cars_pp.mean() * population
    
    transport_data["EV 2006-2010"] = idees["EV 2006-2010"]
    cars_pp = transport_data["EV 2006-2010"] / population
    transport_data.loc[missing, "EV 2006-2010"] = cars_pp.mean() * population
    
    transport_data["EV 2011-2015"] = idees["EV 2011-2015"]
    cars_pp = transport_data["EV 2011-2015"] / population
    transport_data.loc[missing, "EV 2011-2015"] = cars_pp.mean() * population
