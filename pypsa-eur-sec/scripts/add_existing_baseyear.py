...
def add_power_capacities_installed_before_baseyear(n, grouping_years, costs, baseyear, investment_year): # ADDED investment year
    """
    Parameters
    ----------
    n : pypsa.Network
...
# Add ICEVs and EVs -------------------------
    if options["endogenous_transport"] == True:
        ...
        nodal_transport_data["ICEV 2001-2005"] = pop_layout["fraction"] * nodal_transport_data["ICEV 2001-2005"]
        nodal_transport_data["ICEV 2006-2010"] = pop_layout["fraction"] * nodal_transport_data["ICEV 2006-2010"]
        nodal_transport_data["ICEV 2011-2015"] = pop_layout["fraction"] * nodal_transport_data["ICEV 2011-2015"]
        nodal_transport_data["EV 2001-2005"] = pop_layout["fraction"] * nodal_transport_data["EV 2001-2005"]
        nodal_transport_data["EV 2006-2010"] = pop_layout["fraction"] * nodal_transport_data["EV 2006-2010"]
        nodal_transport_data["EV 2011-2015"] = pop_layout["fraction"] * nodal_transport_data["EV 2011-2015"]
        ice_efficiency = snakemake.config['sector']['transport_internal_combustion_efficiency']
        lifetime_EV = snakemake.config['sector']['lifetime_EV']
        lifetime_ICEV = snakemake.config['sector']['lifetime_ICEV']
        capital_costs=pd.read_csv(snakemake.input.capital_costs_name, index_col=0)
        capital_cost_ICEV = capital_costs["ICEV_FOM"]
        capital_cost_EV = capital_costs["EV_FOM"]
        ...
        nodal_transport_data["ICEV_power"] = V*nodal_transport_data["average fuel efficiency"]*10**(-3)
        nodal_transport_data["EV_power"] = V*battery_to_wheels_eta*10**(-3) # Convert to MWh
        avg_ICEV_power = nodal_transport_data["ICEV_power"].sum()/len(nodal_transport_data["ICEV_power"])
        avg_EV_power = nodal_transport_data["EV_power"].sum()/len(nodal_transport_data["EV_power"]) 
        
        # Calculation of power by the vehicles:
        #2001-2005
        ICEV_power_2003 = nodal_transport_data["ICEV 2001-2005"]*avg_ICEV_power
        EV_power_2003 = nodal_transport_data["EV 2001-2005"]*avg_EV_power
        #2006-2010
        ICEV_power_2008 = nodal_transport_data["ICEV 2006-2010"]*avg_ICEV_power
        EV_power_2008 = nodal_transport_data["EV 2006-2010"]*avg_EV_power
        #2011-2015
        ICEV_power_2013 = nodal_transport_data["ICEV 2011-2015"]*avg_ICEV_power
        EV_power_2013 = nodal_transport_data["EV 2011-2015"]*avg_EV_power
        ...
        for ind in nodes:
            ...
            n.add("Link",
                        ...
                        capital_cost=capital_cost_ICEV[ind], #NB: fixed cost is per MWel
                        efficiency=ice_efficiency,
                        efficiency2=costs.at["oil", 'CO2 intensity'],
                        p_max_pu=1-n.links_t.p_max_pu['AL0 0 BEV charger-'+str(investment_year)], #avail_profile_ICEV[ind+" ICEV"],
                        p_nom=ICEV_power_2003[ind],
                        build_year=2003,
                        lifetime=lifetime_ICEV # Notice, lifetime changed to 11 years from 9 years.
                    )
            ...
            n.add("Link",
                        ...
                        capital_cost=capital_cost_EV[ind], #NB: fixed cost is per MWel
                        efficiency=1,
                        p_max_pu=1-n.links_t.p_max_pu['AL0 0 BEV charger-'+str(investment_year)],
                        p_nom=EV_power_2003[ind],
                        build_year=2003,
                        lifetime=lifetime_EV
                    )
...
if __name__ == "__main__":
    ...
    investment_year = int(snakemake.wildcards.planning_horizons) # Added this
    
    add_power_capacities_installed_before_baseyear(n, grouping_years, costs, baseyear, investment_year)
